...
namespace MagePsycho\DiscountLimit\Block\Adminhtml\System\Config\Form\Fieldset;
...
class Support extends Template implements RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'MagePsycho_DiscountLimit::system/config/form/fieldset/support.phtml';
