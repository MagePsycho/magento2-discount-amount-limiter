...
namespace MagePsycho\DiscountLimit\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    const PRODUCT_URL = 'https://www.magepsycho.com/';

    const MODULE_NAME = 'MagePsycho_DiscountLimit';

    const VERSION_CACHE_KEY = 'magepsycho-discountlimit-module-version';
